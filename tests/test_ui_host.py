...
class UiHostStructureTests(unittest.TestCase):
    ...
    def test_cpp_ui_host_builds_against_qt_qml(self):
        ...
        self.assertIn("qml.qrc", cmake)
        self.assertNotIn("install(FILES", cmake)
        self.assertNotIn("ECHOFLOW_QML_DIR", cmake)
        self.assertNotIn("ECHOFLOW_QML_SOURCE_DIR", cmake)
        self.assertIn("qrc:/qml/EchoFlowTooltip.qml", main_cpp)
